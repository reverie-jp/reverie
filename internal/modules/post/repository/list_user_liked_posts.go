...
func (r *repositoryImpl) ListUserLikedPosts(ctx context.Context, params ListUserLikedPostsParams) ([]*entity.Post, error) {
	...
	rows, err := r.q.ListUserLikedPosts(ctx, sqlc.ListUserLikedPostsParams{
