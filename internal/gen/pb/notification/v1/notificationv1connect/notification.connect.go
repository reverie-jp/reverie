...
const (
	...
	NotificationServiceMarkNotificationsReadProcedure = "/notification.v1.NotificationService/MarkNotificationsRead"
	...
	NotificationServiceGetUnreadNotificationCountProcedure = "/notification.v1.NotificationService/GetUnreadNotificationCount"
)
...
// MarkNotificationsRead calls notification.v1.NotificationService.MarkNotificationsRead.
...
// GetUnreadNotificationCount calls notification.v1.NotificationService.GetUnreadNotificationCount.
...
func (UnimplementedNotificationServiceHandler) MarkNotificationsRead(context.Context, *connect.Request[v1.MarkNotificationsReadRequest]) (*connect.Response[v1.MarkNotificationsReadResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("notification.v1.NotificationService.MarkNotificationsRead is not implemented"))
}
...
func (UnimplementedNotificationServiceHandler) GetUnreadNotificationCount(context.Context, *connect.Request[v1.GetUnreadNotificationCountRequest]) (*connect.Response[v1.GetUnreadNotificationCountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("notification.v1.NotificationService.GetUnreadNotificationCount is not implemented"))
}
