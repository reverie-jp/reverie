...
import (
	...
	errors "errors"
	http "net/http"
	v1 "reverie.jp/reverie/internal/gen/pb/event/v1"
	strings "strings"
)
...
const (
	...
	// RPC.
	EventServiceStreamEventsProcedure = "/event.v1.EventService/StreamEvents"
)
...
// StreamEvents calls event.v1.EventService.StreamEvents.
func (c *eventServiceClient) StreamEvents(ctx context.Context, req *connect.Request[v1.StreamEventsRequest]) (*connect.ServerStreamForClient[v1.StreamEventsResponse], error) {
...
func (UnimplementedEventServiceHandler) StreamEvents(context.Context, *connect.Request[v1.StreamEventsRequest], *connect.ServerStream[v1.StreamEventsResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("event.v1.EventService.StreamEvents is not implemented"))
}
